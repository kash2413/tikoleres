...
},{"ev-emitter":2,"get-size":4}],6:[function(require,module,exports){
/*!
 * Outlayer v2.1.1
...
},{"./item":5,"ev-emitter":2,"fizzy-ui-utils":3,"get-size":4}],"@tarekraafat/autocomplete.js":[function(require,module,exports){
...
},{"get-size":4,"outlayer":6}],"slick-carousel":[function(require,module,exports){
/*
     _ _      _       _
 ___| (_) ___| | __  (_)___
/ __| | |/ __| |/ /  | / __|
...
},{"jquery":"jquery"}],"wowjs":[function(require,module,exports){
(function() {
...
;(function ($) {
    ...
    function _skewLayerHandler() {
        $(".skew-bottom.overlap-below, .skew-bottom.overloap-below").get().reverse().forEach((element, i)=>{
...
;(function($){
    ...
    function _iframeDialogHandler(e) {
        e.preventDefault();

        const target = $(e.target);
        const iframeDialogInput = $(target.attr('data-iframe-dialog'));

        if(!iframeDialogInput.get(0)) {
            return false;
        }

        const iframeElem =  $(iframeDialogInput.val());

        if(!iframeElem.get(0)) {
            return false;
        }

        window.___iframeDialogRef = iframeElem;

        $('body').append(iframeElem).css({"overflow": "hidden"});

    }

    function _closeIframeDialog() {
        const selector = `#${window.___iframeDialogRef.attr("id")}`;
        const _$ = $;
        $(selector).remove();
        $('body').css({"overflow": "visible"});
    }

    function _messageHandler(t) {
        if ("clic2buy:closeWidgetPopin" === t.originalEvent.data) {
            _closeIframeDialog();
        }
    }

    function _addEvents() {
        $(document).on("click", "[data-iframe-dialog]", _iframeDialogHandler);
        $(window).on("message", _messageHandler);
...
;(function($){
    ...
    function _applyInstafeed(token) {
        var feed = new Instafeed({
            accessToken: token,
              limit:4,
              sortBy: 'most-liked',
            resolution: 'standard_resolution',
           template:'<div class="social-feed"><a href="{{link}}"> <img class="img-fluid" "title="{{caption}}" src="{{image}}" /></a></div>',
        });
    ...
    function _init() {
        const token = $('input[name="instaAccTkn"]').val() || 'IGQVJVR3hfWnNyUWR1Y0JhNE5SOWVKeWFabTRrUnI4VVBkdFF6NXNSQUVqdmdiZA0tIYThLcE93U1Bad2JLY2JvNEtjdE9tc1kwRmV0QlFNenRZAY1VfQURuRFg5MS1VUHhBcEZAvTlFrdWZAUbk5Bd0dPZAQZDZD';
        if(token) {
            _applyInstafeed(token);
        }
    }
